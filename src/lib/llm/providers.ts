...
export const LLM_PROVIDERS: LlmProviderDef[] = [
  ...
  },
  {
    ...
    models: ['google/gemini-2.5-flash', 'google/gemini-2.5-flash-lite', 'anthropic/claude-haiku-4-5-20251001', 'anthropic/claude-sonnet-4-5', 'openai/gpt-4o-mini', 'google/gemini-2.0-flash-001'],
